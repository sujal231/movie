...
import com.example.movie.API.topratedinterface
...
class TopRatedFragment : Fragment() {
    ...
    private fun callapi() {
        ...
        var api = APIClient.getapiclient().create(topratedinterface::class.java)

        api.gettopratedmovie().enqueue(object : Callback<Movielistmodel> {
